<?php
/**
 * The Template for Pending Booking Email content
 *
 * Email that will be sent to administrator after booking is placed.
 *
 * @version 2.0.0
 */
...
<?php echo esc_html( sprintf( __( 'Booking #%s is pending for Administrator approval.', 'motopress-hotel-booking' ), '%booking_id%' ) ); ?>
