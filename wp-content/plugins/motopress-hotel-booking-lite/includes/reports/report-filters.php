...
class ReportFilters {
    ...
    const REPORT_TYPES = ['earnings'];

    const DEFAULT_REPORT_TYPE = 'earnings';

    const DATES_RANGE_TYPES = ['today', 'yesterday', 'this_week', 'last_week',
    'last_thirty_days', 'this_month', 'last_month', 'this_quarter', 'last_quarter',
