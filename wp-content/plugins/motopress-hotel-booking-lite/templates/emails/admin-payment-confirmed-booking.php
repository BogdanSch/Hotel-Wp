<?php
/**
 * The Template for Approved Booking Email (via payment)
 *
 * Email that will be sent to Admin when payment is completed.
 *
 * @version 2.0.0
 */
...
<?php echo esc_html( sprintf( __( 'Booking #%s is confirmed by payment.', 'motopress-hotel-booking' ), '%booking_id%' ) ); ?>
<br/><br/><a href="%booking_edit_link%"><?php esc_html_e( 'View Booking', 'motopress-hotel-booking' ); ?></a>
<h4><?php esc_html_e( 'Details of payment', 'motopress-hotel-booking' ) ?></h4>
<?php echo esc_html( sprintf( __( 'Payment ID: #%s', 'motopress-hotel-booking' ), '%payment_id%' ) ); ?>
<br/>
<?php echo esc_html( sprintf( __( 'Amount: %s', 'motopress-hotel-booking' ), '%payment_amount%' ) ); ?>
<br/>
<?php echo esc_html( sprintf( __( 'Method: %s', 'motopress-hotel-booking' ), '%payment_method%' ) ); ?>
<br/>
