                    ...
                    <?php foreach ($this->products as $product) { ?>
						...
						<div class="mphb-extension">
							...
							<div class="mphb-extension-content">
								...
								<p class="mphb-extension-excerpt"><?php 
                                    // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                    echo wp_trim_words( esc_html($product['excerpt']), 25 ); ?></p>
								<a href="<?php echo esc_url($utmLink); ?>" class="mphb-extension-link button" target="_blank"><?php
									esc_html_e('Get this Extension', 'motopress-hotel-booking'); ?></a>
							</div>
                        </div>
                    <?php } ?>
                </div>
